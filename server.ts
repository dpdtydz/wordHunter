...
• wordHint: 단어의 사전적 의미·어원·실생활 용례만을 바탕으로 작성한 학습 힌트 (1~2문장). 넥서스·캐릭터·판타지 세계관 표현 절대 금지. 단어를 직접 언급하지 말고, 실제 영어 학습자가 단어를 유추할 수 있도록 작성. 예) HARVEST → "농작물을 거두어들이는 계절적 활동을 뜻하며, 노력의 결실을 얻는다는 비유적 의미로도 쓰입니다."
...
모든 필드는 한국어로 작성 (visualKeywords, gender는 영문). JSON 형식으로 반환.
      ...
      const schema = {
        ...
        required: ["word","wordKorean","wordDefinition","wordHint","visualKeywords","weapon","gender","category","characterName","charDescription","rarity"],
      };
